	...
	<div class="card card-outline card-primary">
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button class="btn btn-primary btn-xl  bg-gradient-primary mx-2" form="manage-staff">Save</button>
  			<a class="btn btn-primary btn-xl bg-gradient-secondary mx-2" href="./indexmin.php?page=staff_list">Cancel</a>
  		</div>
  	</div>
	</div>
</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
              location.href = 'indexmin.php?page=staff_list'
					},2000)
				}else if(resp == 2){
