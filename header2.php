    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container px-4 px-lg-5">
				<!-- Logo -->
                <!--a class="navbar-brand"  href="./"><img src="./assets/core-img/mycsc3.png" alt=""></a-->
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
					...
					<!--li class="nav-item"><a class="nav-link" href="./trackdisk.php">Track Your Disk</a></li-->
				     ...
				     <!-- Header section-->
        <section class="page-section bg-primary" id="mainhead">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 text-center">
					&nbsp;
                        <h2 class="text-white mt-0">Your Privacy is Our Priority</h2>
