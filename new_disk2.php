	...
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-6">
			  ...
			  <div class="form-group">
                ...
                <input type="text" name="sender_ic" id="" class="form-control form-control-sm" value="<?php echo isset($sender_ic) ? $sender_ic : '' ?>" required>
              </div>
              <div class="form-group">
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-disk">Save</button>
  			<a class="btn btn-flat bg-gradient-secondary mx-2" href="./indexmin.php?page=disk_list">Cancel</a>
  		</div>
  	</div>
	</div>
</div>
